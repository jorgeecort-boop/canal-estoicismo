...
# Test with Windows backslash path
...
text_filter = (f"drawtext=text='{escaped}':"
               f"fontfile='{font_path}':"
               f"fontsize=72:fontcolor=0xF5F0E1:bordercolor=0x1A1A1A:borderw=3:"
               f"x=(w-text_w)/2:y=h-text_h-120:line_spacing=1.3:"
